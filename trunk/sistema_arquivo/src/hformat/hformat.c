...
int save_boot(short int tam_hpsys) {
	...
	fseek(disk, (2*SIZE_SEC)-6-1, SEEK_SET); /* 6 é a soma de 2 char + 2 short int e -1 pra acertar a referencia */
	fwrite(2+tam_hpsys, sizeof(short int), 1, disk); //TODO: Tratar erro
	fwrite(tam_hpsys, sizeof(short int), 1, disk); //TODO: Tratar erro
	fwrite(BOOT1, sizeof(char), 1, disk); //TODO: Tratar erro
	fwrite(BOOT2, sizeof(char), 1, disk); //TODO: Tratar erro
