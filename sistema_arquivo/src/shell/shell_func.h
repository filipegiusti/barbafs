...
// void func_search_str(int argc, char *argv[]);     //TODO: Se der tempo, faço o código desta funcao ( procura uma ocorrencia de uma string dentro de um arquivo )

void func_help(int argc, char *argv[]);    //TODO: função que exibe informações sobre o shell de comandos
